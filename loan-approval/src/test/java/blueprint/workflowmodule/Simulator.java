 ...
 *
 * <p>
 * A concrete simulator subclasses this, replaces the real client as an
 * {@code @Alternative} bean of the test sources, calls {@link #record(String)} in every
 * method it offers, and adds the methods a test needs to make it answer.
 * </p>
 *
 * <pre>
 * &#64;Alternative
 * &#64;Priority(1)
 * &#64;ApplicationScoped
 * public class RatingServiceSimulator extends Simulator implements RatingService { ... }
 * </pre>
 *
 * <p>
